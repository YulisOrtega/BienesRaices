...
const emailRegister = async (userData) => {
    ...
    await transport.sendMail({
        ...
        html: `<title style="text-color: #54c6eb;">Real Estate</title>
        <div style="background: #06d6a0">
        <h2 style="font-size: 16px; font-family: Arial, sans-serif; text-align: center; text-color: #048a81">Hola, ${name}</h2>
        <img src="https://th.bing.com/th/id/R.1dba9de11d6276edce7645b49ad48e07?rik=We6iqIJqeAvRCw&pid=ImgRaw&r=0" style="max-width: 10%; display: block;
        margin: 0 auto;">
    ...
    <span style="text-align: center;">Yulissa Ortega Cuevas</span>
</div>
        <div style="display: flex; align-items: center;background: #54c6eb;">
            <img src="https://th.bing.com/th/id/OIP.xSWdOXnT-Fw10DZLWBnfmAHaHa?pid=ImgDet&w=474&h=474&rs=1" style="max-width: 4%;">
        ...
        <div style="display: flex; align-items: center; align: left; background: #54c6eb;">
